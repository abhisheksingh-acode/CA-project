...
<?php $title = 'ConsoLegal | Business Loan'; ?>
...
<body>
   ...
   <section class="business-loan header-height" id="business-loan">
      <h2 class="main-title">Business Loan Upto ₹ 50,00,000</h2>
      <div class="estimation-div">
         ...
         <button class="btn mx-auto d-block an-btn mb-2">Apply For Business Loan Now</button>
