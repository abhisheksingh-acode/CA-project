<!-- <nav class="navbar navbar-expand-lg navbar-light bg-white sticky-top flex-column">
   <ul class="top-nav-strip d-sm-none">
      <li class="nav-item">
         <a class="nav-link text-white" href="#"> <i class="fab text-success fw-bold fa-whatsapp"></i> 9854859385</a>
      </li>
      <li class="nav-item">
         <a class="nav-link p-0 text-white" href="#"> <i class="fas theme-blue fa-phone-alt"></i> 9854859385</a>
      </li>
      <li class="nav-item">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
         <ul class="navbar-nav ms-auto mb-2 mb-lg-0 align-items-start align-items-md-center">
            ...
            <ul class="navbar-nav d-none d-md-flex">
               <li class="nav-item">
                  <a class="nav-link" href="#"> <i class="fab text-success fw-bold fa-whatsapp"></i> 9854859385</a>
               </li>
               <li class="nav-item">
...
<nav class="navbar navbar-expand-lg navbar-light bg-white sticky-nav sticky-top flex-column">
   ...
   <div class="collapse navbar-collapse d-none d-lg-flex container" id="navbarSupportedContent">
      <ul class="navbar-nav mx-auto d-none d-lg-flex container-fluid justify-content-center mb-2 mb-lg-0 align-items-start align-items-md-center">
         <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
               Incorporation
            </a>
