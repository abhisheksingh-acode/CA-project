...
<?php $title = 'ConsoLegal | Home Loan'; ?>
...
<body>
   ...
   <section class="home-loan header-height" id="home-loan">
      <h2 class="main-title">Home Loan Upto ₹ 50,00,000</h2>
      <div class="estimation-div">
         ...
         <button class="btn mx-auto d-block an-btn mb-2">Apply For Home Loan Now</button>
